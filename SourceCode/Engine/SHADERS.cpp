...
HRESULT SHADERMANAGER::Initialize()
{
    ...
    Insert(L"Shaders/Shader_2d.fx", ied_2d, ied_2d_size);
    Insert(L"Shaders/PhongShader.fx", ied_p, ied_p_size);
    Insert(L"Shaders/Base3DShader.fx", ied_p, ied_p_size);
    Insert(L"Shaders/DebugShader.fx", ied_d, ied_d_size);
    return S_OK;
}
